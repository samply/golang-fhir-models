...
type OtherIsipRelatedPerson IsipRelatedPerson

// MarshalJSON marshals the given RelatedPerson as JSON into a byte slice
func (r IsipRelatedPerson) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		OtherIsipRelatedPerson
		ResourceType string `json:"resourceType"`
	}{
		OtherIsipRelatedPerson: OtherIsipRelatedPerson(r),
		ResourceType:       "RelatedPerson",
	})
}

// UnmarshalIsipRelatedPerson unmarshals a RelatedPerson.
func UnmarshalIsipRelatedPerson(b []byte) (IsipRelatedPerson, error) {
	var relatedPerson IsipRelatedPerson
